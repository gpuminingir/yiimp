...
foreach($algos as $item)
{
	...
	if($defaultalgo == $algo)
		echo "<tr style='border-bottom:1pt solid black;cursor: pointer; background-color: #e0d3e8;' onclick='javascript:select_algo(\"$algo\")'>";
	else
	...
	if ($coins > 0){
	    ...
	    foreach($list as $coin){
	        ...
	        echo "<tr>";
	        echo "<td align='left' valign='top' style='font-size: .8em;padding-left:10px;'><img width='10' src='".$coin->image."'>  <b>$name</b> <span style='font-size: .8em'>($symbol)</span></td>";
